...
public class title implements ActionListener
{
	...
	public JLabel T1= new JLabel("SIMPS USING SOCIOLOGY FOR PERSONAL MOBILITY");
	public JLabel T2= new JLabel("IEEE/ACM  Transaction On Networking");
	public JLabel T3= new JLabel("Vol.17,No.3, June 2009");
